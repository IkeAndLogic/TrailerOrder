...
namespace TrailerOrder.ViewModels
{
    public class EditEmployeeViewModel
    {
        ...
        public EditEmployeeViewModel(Employee employee)
        {
            ...
            this.StreetNumber = employee.StreetNumber;
            this.StreetName = employee.StreetName;
            this.City = employee.City;
            this.ZipCode = employee.ZipCode;
            this.SSN = employee.SSN;
            this.SsnConfirm = employee.SsnConfirm;
            this.Dob = employee.Dob;
            this.LicNumber = employee.LicNumber;
            this.LicIssue = employee.LicIssue;
            this.LicExpire = employee.LicExpire;
            this.MedCardNumber = employee.MedCardNumber;
            this.MedIssue = employee.MedIssue;
            this.MedExpire = employee.MedExpire;
            this.UserName = employee.UserName;
            this.Password = employee.Password;
            this.PasswordConf = employee.PasswordConf;
